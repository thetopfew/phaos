...
<table width="90%" border="1" cellspacing="0" cellpadding="3" align="center">
  <tr style=background:#006600;> 
    <td colspan="2"> 
      <div align="center"><b>WoP - Armors List</b></div>
    </td>
  </tr>
<!-- <tr><center><form><input type='button' onClick="history.go(-1);return true;" value='Go Back'></form></center></tr><br> -->
  <tr> 
	<?php
	$self = mysqli_query($db, "SELECT * FROM phaos_armor ORDER BY buy_price ASC");
