...
{
	mysqli_query($db, "UPDATE phaos_characters SET name='$name', hit_points='$hit_points', race='$race', class='$class', xp='$xp', gold='$gold', image_path='$image', location='$location' WHERE id='$id'");
...
{
	$self = mysqli_query($db, "SELECT * FROM phaos_characters WHERE id=$wrldchr");
...
<input type="hidden" name="id" value="<?php echo $id; ?>">
    ...
    <tr> 
	  ...
	  <?php
	  $result = mysqli_query($db, "SELECT * FROM phaos_locations ORDER BY name ASC");
