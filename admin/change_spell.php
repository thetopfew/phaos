...
if($changeme == "yes")
{
	...
	mysqli_query($db, "UPDATE phaos_spells_items SET name='$name', min_damage='$min_damage', max_damage='$max_damage', buy_price='$buy_price', sell_price='$sell_price', image_path='$image_path', req_skill='$req_skill', damage_mess='$damage_mess' WHERE id='$id'");
...
{
	$self = mysqli_query($db, "SELECT * FROM phaos_spells_items WHERE id=$spell");
