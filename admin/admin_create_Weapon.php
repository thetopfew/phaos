...
if($addme == "yes")
{
	mysqli_query($db, "INSERT INTO phaos_weapons (name, min_damage, max_damage, buy_price, sell_price, image_path) VALUES ('$name','$min_damage', '$max_damage', '$buy_price', '$sell_price', '$image_path')");
	?>
