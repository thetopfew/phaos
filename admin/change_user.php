...
if($changeme == "yes") {
	if($password == "") {
		mysqli_query($db, "UPDATE phaos_users SET username='$username', email_address='$email_address', full_name='$full_name' WHERE id='$id'");
	}	else {
		mysqli_query($db, "UPDATE phaos_users SET username='$username', password=md5('$password'), email_address='$email_address', full_name='$full_name' WHERE id='$id'");
	}
	...
	$self = mysqli_query($db, "SELECT * FROM phaos_users WHERE id=$user");
...
<form action="change_user.php?changeme=yes" method=post>
  ...
  <table width="600" border="1" cellspacing="0" cellpadding="3">
    ...
    <tr> 
      <td width="50%"><b><font color="#FFFFFF">Location ID</font></b></td>
      <td width="50%"> <b><font color="#FFFFFF">
        <input type="text" name="id" value="<?php echo $id; ?>">
        </font></b></td></td>
    </tr>
    <tr> 
      <td width="50%"><b><font color="#FFFFFF">Username</font></b></td>
      <td width="50%"> <b><font color="#FFFFFF">
        <input type="text" name="username" value="<?php echo $username; ?>">
        </font></b></td></td>
    </tr>
    <tr> 
      <td width="50%"><b><font color="#FFFFFF">New Password?<br>(Will be MD5 encrypted)</font></b></td>
      <td width="50%"> <b><font color="#FFFFFF">
