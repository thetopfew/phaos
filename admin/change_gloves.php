...
{
	mysqli_query($db, "UPDATE phaos_gloves SET name='$name', armor_class='$armor_class', buy_price='$buy_price', sell_price='$sell_price', image_path='$image_path' WHERE id='$id'");
...
{
	$self = mysqli_query($db, "SELECT * FROM phaos_gloves WHERE id=$gloves");
