...
if($addme == "yes")
{
	mysqli_query($db, "INSERT INTO phaos_gloves (name, armor_class, buy_price, sell_price, image_path) VALUES ('$name','$armor_class', '$buy_price', '$sell_price', '$image_path')");
	?>
	<table width="100%" height="100%" border="0" cellpadding="2" cellspacing="0">
	  ...
	  <td align=center valign=middle height="100%" width="100%">
		  ...
		  <td colspan="2" align=center>
		  	<b>New Gloves has been created!</b>
		  </td>
		  </tr>
		  <tr>
		  <td colspan="2" align=center>
