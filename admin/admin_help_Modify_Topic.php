...
<hr>
<?php
$conn = mysqli_connect("$game_host", "$game_dbuser", "$game_dbpasswd", "$game_db") or die ("Unable to connect to MySQL server.");
...
$result = mysqli_query($db, "SELECT * FROM phaos_help WHERE id = '$topic'");
