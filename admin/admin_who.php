...
$active_check = mysqli_query($db, "SELECT * FROM phaos_characters WHERE regen_time >= '$active_min' AND regen_time <= '$active_max' AND username != 'phaos_npc' AND username != 'phaos_npc_arena' ORDER by name ASC");

if ($row = mysqli_fetch_array($active_check)) {$active = "yes";}
