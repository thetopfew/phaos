...
<html>
<head>
<title>WoP Admin Panel - Create Shields</title>
...
if($addme == "yes")
{
	mysqli_query($db, "INSERT INTO phaos_shields (name, armor_class, buy_price, sell_price, image_path) VALUES ('$name','$armor_class', '$buy_price', '$sell_price', '$image_path')");
	?>
