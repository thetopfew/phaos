...
if($changeme == "yes")
{
	mysqli_query($db, "UPDATE phaos_weapons SET name='$name', min_damage='$min_damage', max_damage='$max_damage', buy_price='$buy_price', sell_price='$sell_price', image_path='$image_path' WHERE id='$id'");
...
{
	$self = mysqli_query($db, "SELECT * FROM phaos_weapons WHERE id=$weapon");
