...
if($changeme == "yes") {
	...
	$result = mysqli_query($db, "SELECT * FROM phaos_characters WHERE id=$character");
	while ($row = mysqli_fetch_array($result)) {
		...
		if($sex == "") {
			...
			$result = mysqli_query($db, "SELECT * FROM phaos_sex WHERE sex = '$sex'");
			if ($row = mysqli_fetch_array($result)) {$sex_sex = $row["sex"];}
		}
		
		if($race == "") {
			$race_name = "Please select a race";
		} else {
			$result = mysqli_query($db, "SELECT * FROM phaos_races WHERE name = '$race'");
			if ($row = mysqli_fetch_array($result)) {$race_name = $row["name"];}
		}
		
		if($class == "") {
			$class_name = "Please select a class";
		} else {
			$result = mysqli_query($db, "SELECT * FROM phaos_classes WHERE name = '$class'");
			if ($row = mysqli_fetch_array($result)) {$class_name = $row["name"];}
		}
		
		if($weapon_id == "0") {
			$weapon_name = "None";
		} else {
			$result = mysqli_query($db, "SELECT * FROM phaos_weapons WHERE id = '$weapon_id'");
			if ($row = mysqli_fetch_array($result)) {$weapon_name = $row["name"];}
		}
		
		if($shield_id == "0") {
			$shield_name = "None";
		} else {
			$result = mysqli_query($db, "SELECT * FROM phaos_shields WHERE id = '$shield_id'");
			if ($row = mysqli_fetch_array($result)) {$shield_name = $row["name"];}
		}
		
		if($helm_id == "0") {
			$helm_name = "None";
		} else {
			$result = mysqli_query($db, "SELECT * FROM phaos_helmets WHERE id = '$helm_id'");
			if ($row = mysqli_fetch_array($result)) {$helm_name = $row["name"];}
		}
		
		if($gloves_id == "0") {
			$gloves_name = "None";
		} else {
			$result = mysqli_query($db, "SELECT * FROM phaos_gloves WHERE id = '$gloves_id'");
			if ($row = mysqli_fetch_array($result)) {$gloves_name = $row["name"];}
		}
		
		if($boots_id == "0") {
			$location_name = "None";
		} else {
			$result = mysqli_query($db, "SELECT * FROM phaos_boots WHERE id = '$boots_id'");
			if ($row = mysqli_fetch_array($result)) {$boots_name = $row["name"];}
		}
		
		if($location_id == "0") {
			$location_name = "Please select a location";
		} else {
			$result = mysqli_query($db, "SELECT * FROM phaos_locations WHERE id = '$location_id'");
			if ($row = mysqli_fetch_array($result)) {$location_name = $row["name"];}
		}
		
		if($dungeon_location_id == "0") {
			$dungeon_location_name = "None";
		} else {
			$result = mysqli_query($db, "SELECT * FROM phaos_locations_dungeon WHERE id = '$dungeon_location_id'");
			if ($row = mysqli_fetch_array($result)) {$dungeon_location_name = $row["name"];}
		}
...
<input type="hidden" name="id" value="<?php echo $id; ?>">
   ...
   <td colspan="2">
		<div align="center"><b>Edit Character for Username: "<?php echo $username; ?>"</b></div>
	</td>
	</tr>
	<tr>
	<td colspan="2">
	...
	<td width="50%"> <b><font color="#FFFFFF">
		<select name="sex">
		<?php
		$result = mysqli_query($db, "SELECT * FROM phaos_sex ORDER BY id ASC");
	...
	<td width="50%"><b><font color="#FFFFFF">
		<select name="race">
		<?php
		$result = mysqli_query($db, "SELECT * FROM phaos_races ORDER BY id ASC");
		if ($row = mysqli_fetch_array($result)) {
			do {
				$id_num = $row["id"];
				$race_name = $row["name"];
	...
	<td width="50%"><b><font color="#FFFFFF">
		<select name="class">
	  	<?php
		$result = mysqli_query($db, "SELECT * FROM phaos_classes ORDER BY id ASC");
		if ($row = mysqli_fetch_array($result)) {
			do {
				$id_num = $row["id"];
				$class_name = $row["name"];
	...
	<tr> 
	<td width="50%"><b><font color="#FFFFFF">Unused Stats</font></b></td>
	<td width="50%"> <b><font color="#FFFFFF">
	...
	<tr> 
	<td width="50%"><b><font color="#FFFFFF">Experience</font></b></td>
	<td width="50%"> <b><font color="#FFFFFF">
	...
	<tr> 
	<td width="50%"><b><font color="#FFFFFF">Stamina</font></b></td>
	<td width="50%"> <b><font color="#FFFFFF">
	...
	<tr> 
	<td width="50%"><b><font color="#FFFFFF">Points to Distribute<br><i>(Max = 7)</i></font></b></td>
	<td width="50%"> <b><font color="#FFFFFF">
    ...
    <tr> 
      ...
      <td width="50%"> <b><font color="#FFFFFF">
        ...
        <option value="0">0. None</option>
			  ...
			  $result = mysqli_query($db, "SELECT * FROM phaos_weapons ORDER BY id ASC");
			  if ($row = mysqli_fetch_array($result)) {
				  do {
					  $id_num = $row["id"];
    ...
    <tr> 
      ...
      <td width="50%"> <b><font color="#FFFFFF">
        ...
        <option value="0">0. None</option>
			  ...
			  $result = mysqli_query($db, "SELECT * FROM phaos_armor ORDER BY id ASC");
			  if ($row = mysqli_fetch_array($result)) {
				  do {
					  $id_num = $row["id"];
					  $armor_name = $row["name"];
    ...
    <tr> 
      ...
      <td width="50%"> <b><font color="#FFFFFF">
        ...
        <option value="0">0. None</option>
			  ...
			  $result = mysqli_query($db, "SELECT * FROM phaos_helmets ORDER BY id ASC");
			  if ($row = mysqli_fetch_array($result)) {
				  do {
					  $id_num = $row["id"];
					  $helm_name = $row["name"];
    ...
    <tr> 
      ...
      <td width="50%"> <b><font color="#FFFFFF">
        ...
        <option value="0">0. None</option>
			  ...
			  $result = mysqli_query($db, "SELECT * FROM phaos_gloves ORDER BY id ASC");
			  if ($row = mysqli_fetch_array($result)) {
				  do {
					  $id_num = $row["id"];
    ...
    <tr> 
      ...
      <td width="50%"> <b><font color="#FFFFFF">
        ...
        <option value="0">0. None</option>
			  ...
			  $result = mysqli_query($db, "SELECT * FROM phaos_boots ORDER BY id ASC");
			  if ($row = mysqli_fetch_array($result)) {
				  do {
					  $id_num = $row["id"];
					  $boots_name = $row["name"];
    ...
    <tr> 
      ...
      <td width="50%"> <b><font color="#FFFFFF">
        ...
        <option value="0">0. None</option>
			  ...
			  $result = mysqli_query($db, "SELECT * FROM phaos_shields ORDER BY id ASC");
			  if ($row = mysqli_fetch_array($result)) {
				  do {
					  $id_num = $row["id"];
    ...
    <tr> 
      ...
      <td width="50%"><b><font color="#FFFFFF">
        <select name="location">
			  <?php
			  $result = mysqli_query($db, "SELECT * FROM phaos_locations ORDER BY id ASC");
			  if ($row = mysqli_fetch_array($result)) {
				  do {
					  $id_num = $row["id"];
    ...
    <tr> 
      ...
      <td width="50%"> <b><font color="#FFFFFF">
        <select name="dungeon_location">
			  ...
			  <?php
			  $result = mysqli_query($db, "SELECT * FROM phaos_locations_dungeon ORDER BY id ASC");
			  if ($row = mysqli_fetch_array($result)) {
				  do {
					  $id_num = $row["id"];
