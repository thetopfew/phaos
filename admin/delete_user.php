...
if($deleteme == "yes")
{
	mysqli_query($db, "DELETE FROM phaos_char_inventory WHERE username='$username'");
	mysqli_query($db, "DELETE FROM phaos_characters WHERE username='$username'");
	mysqli_query($db, "DELETE FROM phaos_users WHERE username='$username'");
...
{
	$self = mysqli_query($db, "SELECT * FROM phaos_characters WHERE username='$username'");
